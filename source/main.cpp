...
int main() {
    ...
    project.mutable_blend_file()->set_download_url("http://192.168.0.236:3309/test_project/untitled.blend");
    auto file = project.add_files();
    file->set_download_url("http://192.168.0.236:3309/test_project/SD-002.IES");
    file->set_relative_path("SD-002.IES");
    file = project.add_files();
    file->set_relative_path("untitled.blend");
    file->set_download_url("http://192.168.0.236:3309/test_project/untitled.blend");
